...
% Persoenliche Daten
\newcommand{\docNachname}{Gam}
\newcommand{\docVorname}{Aymen}
\newcommand{\docStrasse}{Hermann-Ehret-Weg 9}
\newcommand{\docOrt}{Freiburg im Breisgau}
\newcommand{\docPlz}{79111}
\newcommand{\docEmail}{aymen.gam@hs-furtwangen.de}
\newcommand{\docMatrikelnummer}{241344}

% Dokumentdaten
\newcommand{\docTitle}{Realisierung eines Mobiles Embedded Systems }
...
\newcommand{\docArtDerArbeit}{Bachelor Thesis}
...
\newcommand{\docAbgabedatum}{29.02.2016}
\newcommand{\docErsterReferent}{Prof. Dr. Rainer M\"uller}
%\newcommand{\docZweiterReferent}{-} % Wenn es nur einen Betreuer gibt
\newcommand{\docZweiterReferent}{Prof. Dr. Elmar Cochlovius}
